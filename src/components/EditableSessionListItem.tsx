...
interface EditableSessionListItemProps
  extends Omit<SessionListItemProps, "children" | "deleteIcon" | "chatIcon"> {
  /**
...
export const EditableSessionListItem: FC<EditableSessionListItemProps> = ({
  ...
  const { deleteSession, selectSession, activeSessionId } =
  ...
  return (
    <SessionListItem session={session} limit={limit}>
